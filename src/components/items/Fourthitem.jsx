...
import itemImage from "../../assets/shared/image-zx9-speaker.jpg";
import galleryImage1 from "../../assets/product-zx9-speaker/image-gallery-1.jpg";
import galleryImage2 from "../../assets/product-zx9-speaker/image-gallery-2.jpg";
import galleryImage3 from "../../assets/product-zx9-speaker/image-gallery-3.jpg";
import alsoImage1 from "../../assets/shared/image-zx7-speaker.jpg";
...
function Fourthitem() {
  ...
  const items = ["Zx9 Speaker", "$ 4,500", itemImage, itemCount];
  ...
  return (
    <>
      <section className="collection">
        <div className="item">
          <img src={itemImage} alt="image-zx9-speaker" />
        ...
        <div className="also">
          ...
          <div className="item">
            <img src={alsoImage1} alt="image-zx7-speaker" />
