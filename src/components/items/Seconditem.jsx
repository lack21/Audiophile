    ...
    <>
      <section className="collection">
        ...
        <div className="gallery">
          <div className="left-side">
            <img
              src="../src/images/product-xx99-mark-one-headphones/image-gallery-1.jpg"
              alt="image-gallery-1"
            />
            <img
              src="../src/images/product-xx99-mark-one-headphones/image-gallery-2.jpg"
              alt="image-gallery-2"
            />
          </div>
          <img
            src="../src/images/product-xx99-mark-one-headphones/image-gallery-3.jpg"
            alt="image-gallery-3"
            className="right-img"
          />
        </div>
