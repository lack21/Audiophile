...
import itemImage from "../../assets/shared/image-zx7-speaker.jpg";
import galleryImage1 from "../../assets/product-zx7-speaker/image-gallery-1.jpg";
import galleryImage2 from "../../assets/product-zx7-speaker/image-gallery-2.jpg";
import galleryImage3 from "../../assets/product-zx7-speaker/image-gallery-3.jpg";
import alsoImage1 from "../../assets/shared/image-zx9-speaker.jpg";
import alsoImage2 from "../../assets/shared/image-xx99-mark-one-headphones.jpg";
import alsoImage3 from "../../assets/shared/image-xx59-headphones.jpg";

function Fifthitem() {
  const [itemCount, setItemCount] = useState(1);
  const items = ["Zx7 Speaker", "$ 3,500", itemImage, itemCount];
  ...
  return (
    <>
      <section className="collection">
        <div className="item">
          <img src={itemImage} alt="image-zx7-speaker" />
        ...
        <div className="also">
          ...
          <div className="item">
            <img src={alsoImage1} alt="image-zx9-speaker" />
          ...
          <div className="item">
            <img src={alsoImage3} alt="image-xx59-headphones" />
